...
# ============================================================
# ADD YOUR NEW SENTENCES HERE
# Format: { 'filename': 'unique_id', 'text': 'Sinhala sentence' }
# ============================================================
SENTENCES = [
    # --- Example sentences (replace with your own) ---
...
def seed_audio(db):
    ...
    for wav_file in wav_files:
        fname = os.path.splitext(wav_file)[0]  # e.g. "sent_001"

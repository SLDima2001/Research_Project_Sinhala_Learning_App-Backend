...
class StoryService:
                ...
                if data:
                    ...
                    for item in data:
                        ...
                        try:
                            ...
                            # 2. Convert back to dict for MongoDB (by_alias=True if we had aliases)
    ...
    async def get_story(self, story_id: str) -> Optional[schemas.Story]:
        ...
        # Pydantic ignores extra fields like _id by default if configured,
        # but let's be safe and just pass the dict.

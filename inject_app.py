...
while i < len(app_lines):
    ...
    if line.startswith('SINHALA_LETTERS = {') and not inject_dict_done:
        ...
        # Patch `get_random_letter()` logic directly below line 321
...
# Now regex replace get-random-letter fallback
...
# Now regex replace predict fallback
